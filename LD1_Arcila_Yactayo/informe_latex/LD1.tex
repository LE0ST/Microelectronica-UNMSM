...
\begin{enumerate}[leftmargin=1.6em,itemsep=0.25em]
  ...
  \begin{itemize}[leftmargin=1.4em,itemsep=0.1em]
    \item \textbf{Proceso 45~nm HP ($V_{DD}=1.0$~V, $I_{avg}=-2.754~\mu$A):}
    \vspace{-1.5mm}
    $$P_{teor} = \alpha C_L V_{DD}^2 f = (1)(2\times 10^{-15}\text{ F})(1.0\text{ V})^2(1\times 10^9\text{ Hz}) = 2.000~\mu\text{W}$$
    \vspace{-2.5mm}
    $$P_{sim} = |I_{avg}|V_{DD} = |-2.754~\mu\text{A}|(1.0\text{ V}) = 2.754~\mu\text{W} \implies \Delta P = 0.754~\mu\text{W}$$
    \item \textbf{Proceso 45~nm LP ($V_{DD}=1.1$~V, $I_{avg}=-3.097~\mu$A):}
    \vspace{-1.5mm}
    $$P_{teor} = \alpha C_L V_{DD}^2 f = (1)(2\times 10^{-15}\text{ F})(1.1\text{ V})^2(1\times 10^9\text{ Hz}) = 2.420~\mu\text{W}$$
    \vspace{-2.5mm}
    $$P_{sim} = |I_{avg}|V_{DD} = |-3.097~\mu\text{A}|(1.1\text{ V}) = 3.407~\mu\text{W} \implies \Delta P = 0.987~\mu\text{W}$$
  \end{itemize}
  \vspace{-1mm}
...
\centering
\vspace{-2mm}
\includegraphics[width=0.70\linewidth]{figuras/fig4_oscilador_anillo.png}
\vspace{-2mm}
