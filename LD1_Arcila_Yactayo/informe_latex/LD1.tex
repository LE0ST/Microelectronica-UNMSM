...
* --- Mediciones de retardo en las transiciones criticas
.meas tran tplh_worst TRIG V(c) VAL={VDDv/2} FALL=2 TARG V(out) VAL={VDDv/2} RISE=2
.meas tran tphl_c     TRIG V(c) VAL={VDDv/2} RISE=2 TARG V(out) VAL={VDDv/2} FALL=2
