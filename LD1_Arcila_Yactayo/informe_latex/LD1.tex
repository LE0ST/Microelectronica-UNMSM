...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.66\textwidth]{figuras/fig2_tp_vs_cl.png}
\caption{Retardo de propagación medio $t_p$ frente a la capacitancia de carga $C_L \in [1, 8]$~fF en 45~nm HP ($\beta = 2.5$).}
\label{fig:tp_vs_cl}
\end{figure}
\FloatBarrier
