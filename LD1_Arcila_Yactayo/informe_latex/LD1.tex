...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.28\textwidth,height=3.6cm,keepaspectratio]{figuras/fig_esquema_inversor.png}
\caption{Esquema circuital del inversor CMOS básico con dimensionamiento $W_n=4L$ y $W_p=\beta W_n$.}
